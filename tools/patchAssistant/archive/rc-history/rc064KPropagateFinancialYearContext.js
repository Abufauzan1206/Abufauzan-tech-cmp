...
const targets = {
    ledgerBatch: "js/business/ledgerBatchPostingEngine.js",
    journalPosting: "js/business/journalPostingEngine.js"
};

async function run() {
    console.log("=========================================");
    console.log("ABUFAUZAN TECH CMP");
    console.log("RC064K - PROPAGATE FINANCIAL YEAR CONTEXT");
    console.log("=========================================");

    const result = await transaction([
        {
            path: targets.ledgerBatch,
            mode: "exact",
