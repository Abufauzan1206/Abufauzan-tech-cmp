...
const testFile = "testTrialBalance.js";

async function run() {

    console.log("=========================================");
    console.log("ABUFAUZAN TECH CMP");
    console.log("RC062 - ALIGN TRIAL BALANCE NODE TEST");
    console.log("=========================================");
    ...
    const result = await transaction([

        {
            ...
            mode: "regex",
            search:
                'import \\{ CMPTransactionEngine \\} from "\\.\\/js\\/business\\/transactionEngine\\.js";\\s*import \\{ CMPTrialBalanceEngine \\} from "\\.\\/js\\/business\\/trialBalanceEngine\\.js";',
            replace:
...
import { createYear } from "./js/business/financialYearEngine.js";`
...

        {
            ...
            mode: "regex",
            search:
                '// Create a sample transaction\\s*CMPTransactionEngine\\.create\\(\\{\\s*type:\\s*"CONTRIBUTION",\\s*amount:\\s*10000,\\s*description:\\s*"Monthly Contribution"\\s*\\}\\);',
            replace:
...
if (!report.balanced) {
    ...
    console.log("RC062 TRANSACTION RESULT:");
    ...
    console.log("=========================================");
    console.log("RC062 PATCH COMPLETE");
    console.log("=========================================");
}
