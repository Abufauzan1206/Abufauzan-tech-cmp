 ...
 *
 * RC091 - FINANCIAL CLOSING PERSISTENCE VERIFICATION
 * =====================================================
 */
...
async function run() {
    ...
    console.log("RC091 - FINANCIAL CLOSING PERSISTENCE VERIFICATION");
    console.log("=========================================");

    const result =
        await transaction(patches);

    console.log("RC091 TRANSACTION RESULT:");
    ...
    console.log("=========================================");
    console.log("RC091 PATCH COMPLETE");
    console.log("=========================================");
}
