 ...
 *
 * RC098 - CORRECT BASE REPOSITORY TEST
 * =====================================================
 */
...
const patches = [
    {
        ...
        mode: "regex",
        search: `adapter\\.clear\\("baseRepositoryTest"\\);`,
        replace: `CMPMemoryAdapter.clear("baseRepositoryTest");`
    },
    {
        path: "testBaseRepository.js",
        mode: "regex",
        search: `const member = repository\\.create\\(\\{[\\s\\S]*?repository\\.delete\\(member\\.id\\);`,
...
async function run() {
    ...
    console.log("RC098 - CORRECT BASE REPOSITORY TEST");
    console.log("=========================================");

    const result = await transaction(patches);

    console.log("RC098 TRANSACTION RESULT:");
    ...
    console.log("=========================================");
    console.log("RC098 PATCH COMPLETE");
    console.log("=========================================");
}
