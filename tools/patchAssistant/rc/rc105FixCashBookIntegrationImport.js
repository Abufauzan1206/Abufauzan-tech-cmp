 ...
 *
 * RC105 - FIX CASH BOOK INTEGRATION ENGINE IMPORT
 * =====================================================
 */
...
const patches = [
    {
        ...
        mode: "regex",
        search: `import \\{ generateCashBook \\} from "\\./js/business/resultEngine\\.js";`,
...
async function run() {
    ...
    console.log("RC105 - FIX CASH BOOK INTEGRATION IMPORT");
    console.log("=========================================");
