 ...
 *
 * RC141 - PROTECTED DASHBOARD AUTHORIZATION PERSISTENCE
 *
 * Purpose:
 * Verify that protected dashboards continuously enforce
 * Firebase authentication, current-user identity,
 * Firestore profile authorization, and canonical roles
 * after authentication/profile state changes.
 *
 * No production files are modified directly.
 *
 * =====================================================
 */
...
async function run() {
    ...
    console.log("RC141 - PROTECTED DASHBOARD AUTHORIZATION PERSISTENCE");
    console.log("=========================================");

    const result = await transaction(patches);

    console.log("RC141 TRANSACTION RESULT:");
    ...
    console.log("=========================================");
    console.log("RC141 PATCH COMPLETE");
    console.log("=========================================");
}
