 ...
 *
 * RC150 - PROTECTED DASHBOARD AUTHORIZATION HARDENING
 * =====================================================
 */
...
const patches = [
    {
        path: "tools/patchAssistant/test/testProtectedDashboardAuthorizationHardening.js",
        mode: "create",
        search: "",
        replace: `/**
 * =====================================================
...
async function run() {
    ...
    console.log("RC150 - PROTECTED DASHBOARD AUTHORIZATION HARDENING");
    console.log("=========================================");

    const result = await transaction(patches);

    console.log("RC150 TRANSACTION RESULT:");
    console.log(JSON.stringify(result, null, 2));

    if (!result.success) {
        process.exitCode = 1;
        console.log("=========================================");
        console.log("RC150 PATCH FAIL");
        console.log("=========================================");
        return;
    }

    console.log("=========================================");
    console.log("RC150 PATCH COMPLETE");
    console.log("=========================================");

    console.log("Running RC150 test...");
    console.log("=========================================");
    ...
    const test = spawnSync(
        "node",
        [
            "tools/patchAssistant/test/testProtectedDashboardAuthorizationHardening.js"
        ],
        {
            stdio: "inherit"
        }
