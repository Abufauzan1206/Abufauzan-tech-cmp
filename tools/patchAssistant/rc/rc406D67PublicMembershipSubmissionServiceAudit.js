...
const file = "js/services/membershipApplicationService.js";
const source = fs.readFileSync(file, "utf8");

const checks = [
    [
        "APPLICATION_ENGINE_IMPORT_REMAINS",
        /import\s*\{\s*CMPMembershipApplicationEngine\s*\}[\s\S]*from "\.\.\/business\/membershipApplicationEngine\.js";/
    ],
    [
        "FIREBASE_FUNCTIONS_IMPORT_EXISTS",
        /getFunctions,\s*httpsCallable/
    ],
    [
