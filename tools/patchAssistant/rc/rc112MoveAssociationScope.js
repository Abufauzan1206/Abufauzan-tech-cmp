 ...
 *
 * RC112.5 - MOVE RC112 ASSOCIATION TEST INTO TRY SCOPE
 * =====================================================
 */
...
const patches = [
    {
        ...
        mode: "regex",
        search: `\\n\\s*// -------------------------------------------------\\s*\\n\\s*// RC112 - Budget / Financial Year Association[\\s\\S]*?report \\+=\\s*"TEST COMPLETE\\\\\\\\n";`,
        replace: ``
    },
    {
        path: "testBudgetLifecycleEngine.js",
...
async function run() {
    ...
    console.log("RC112.5 - MOVE RC112 ASSOCIATION TEST INTO TRY SCOPE");
    console.log("=========================================");

    try {
        const result = await transaction(patches);

        console.log("RC112.5 PATCH TRANSACTION RESULT:");
        console.log(JSON.stringify(result, null, 2));

        if (!result.success) {
            process.exitCode = 1;
            console.log("=========================================");
            console.log("RC112.5 PATCH FAIL");
            console.log("=========================================");
            return;
        }

        console.log("=========================================");
        console.log("RC112.5 PATCH COMPLETE");
        console.log("=========================================");

    } catch (error) {
        console.error("RC112.5 PATCH ERROR");
