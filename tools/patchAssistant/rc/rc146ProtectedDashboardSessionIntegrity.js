 ...
 *
 * RC146 - PROTECTED DASHBOARD SESSION INTEGRITY
 *
 * Purpose:
 * Verify that protected dashboard sessions remain bound
 * to the authenticated Firebase user and current
 * Firestore authorization profile across re-entry,
 * role changes, and session termination.
 *
...
async function run() {
    console.log("=========================================");
    console.log("ABUFAUZAN TECH CMP");
    console.log("RC146 - PROTECTED DASHBOARD SESSION INTEGRITY");
    console.log("=========================================");

    const result = await transaction(patches);

    console.log("RC146 TRANSACTION RESULT:");
    ...
    console.log("=========================================");
    console.log("RC146 PATCH COMPLETE");
    console.log("=========================================");

    console.log("Running RC146 test...");
    console.log("=========================================");
