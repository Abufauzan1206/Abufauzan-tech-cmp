 ...
 *
 * RC113 - IMMUTABLE BUDGET FINANCIAL-YEAR ASSOCIATION
 * =====================================================
 */
...
const patches = [
    {
        ...
        mode: "regex",
        search: `(export async function modifyBudget\\([\\s\\S]*?if \\(budget\\.status === "CLOSED"\\) \\{[\\s\\S]*?\\}\\s*)(if \\(budget\\.status === "CLOSED"\\))`,
        replace: `$1if (data?.financialYearId !== undefined &&
...
async function run() {
    ...
    console.log("RC113 - IMMUTABLE BUDGET FINANCIAL-YEAR ASSOCIATION");
    console.log("=========================================");
