 ...
 *
 * RC132 - PROTECTED DASHBOARD SESSION PERSISTENCE
 *
 * Purpose:
 * 1. Verify authenticated session handling on dashboard load.
 * 2. Verify Firestore profile retrieval by authenticated UID.
 * 3. Verify canonical privileged roles.
 * 4. Preserve legacy role aliases.
 * 5. Verify unauthorized roles remain rejected.
 * 6. Verify missing profiles are safely rejected.
 * 7. Verify dashboard boundaries remain isolated.
 *
 * =====================================================
 */
...
const patches = [
    {
        path: "tools/patchAssistant/test/testProtectedDashboardSessionPersistence.js",
        mode: "create",
        search: "",
        replace: `/**
 * =====================================================
...
async function run() {
    console.log("=========================================");
    console.log("ABUFAUZAN TECH CMP");
    console.log("RC132 - PROTECTED DASHBOARD SESSION PERSISTENCE");
    console.log("=========================================");

    const result = await transaction(patches);

    console.log("RC132 TRANSACTION RESULT:");
    ...
    console.log("=========================================");
    console.log("RC132 PATCH COMPLETE");
    console.log("=========================================");
}
