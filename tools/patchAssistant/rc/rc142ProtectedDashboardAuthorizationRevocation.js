 ...
 *
 * RC142 - PROTECTED DASHBOARD AUTHORIZATION REVOCATION
 *
 * Purpose:
 * Verify that protected dashboards cannot retain access
 * after the authenticated user's authorization is revoked,
 * changed, removed, or becomes invalid.
 *
...
async function run() {
    ...
    console.log("RC142 - PROTECTED DASHBOARD AUTHORIZATION REVOCATION");
    console.log("=========================================");

    const result = await transaction(patches);

    console.log("RC142 TRANSACTION RESULT:");
    ...
    console.log("=========================================");
    console.log("RC142 PATCH COMPLETE");
    console.log("=========================================");
}
