 ...
 *
 * RC143 - PROTECTED DASHBOARD ROLE DRIFT
 *
 * Purpose:
 * Verify that protected dashboards cannot retain
 * authorization when the Firestore role changes.
 *
...
const patches = [
    {
        path: "tools/patchAssistant/test/testProtectedDashboardRoleDrift.js",
        mode: "create",
        search: "",
...
async function run() {
    console.log("=========================================");
    console.log("ABUFAUZAN TECH CMP");
    console.log("RC143 - PROTECTED DASHBOARD ROLE DRIFT");
    console.log("=========================================");

    const result = await transaction(patches);

    console.log("RC143 TRANSACTION RESULT:");
    ...
    console.log("=========================================");
    console.log("RC143 PATCH COMPLETE");
    console.log("=========================================");

    console.log("Running RC143 test...");
    console.log("=========================================");
    ...
    const test = spawnSync(
        "node",
        [
            "tools/patchAssistant/test/testProtectedDashboardRoleDrift.js"
        ],
        {
            stdio: "inherit"
        }
