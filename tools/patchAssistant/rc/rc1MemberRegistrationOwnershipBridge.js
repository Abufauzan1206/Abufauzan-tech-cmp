...
import {
  ...
  },
  {
    path: "modules/member-registration/script.js",
    mode: "exact",
    search: `cooperative: document.getElementById("cooperative").value,
membershipNumber: document.getElementById("membershipNumber").value.trim()`,
    replace: `cooperative: document.getElementById("cooperative").value,
        membershipNumber: document.getElementById("membershipNumber").value.trim()`
  },
  {
    path: "modules/members/registration/app.js",
    mode: "exact",
    search: `cooperativeId: profile.cooperativeId ?? null
            });`,
    replace: `cooperativeId: profile.cooperativeId
            });
            ...
            if (
                ...
                throw new Error(
                    "Super Admin member registration requires a selected cooperative."
                );
            }`
  }
];
