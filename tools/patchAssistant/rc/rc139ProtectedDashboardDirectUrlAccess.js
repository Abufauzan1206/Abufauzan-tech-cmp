 ...
 *
 * RC139 - PROTECTED DASHBOARD DIRECT-URL ACCESS GUARD
 *
 * Purpose:
 * Verify that direct URL access cannot bypass:
...
const patches = [
    {
        path: "tools/patchAssistant/test/testProtectedDashboardDirectUrlAccess.js",
        mode: "create",
        search: "",
        replace: `/**
 * =====================================================
...
async function run() {
    console.log("=========================================");
    console.log("ABUFAUZAN TECH CMP");
    console.log("RC139 - PROTECTED DASHBOARD DIRECT-URL ACCESS GUARD");
    console.log("=========================================");

    const result = await transaction(patches);

    console.log("RC139 TRANSACTION RESULT:");
    ...
    console.log("=========================================");
    console.log("RC139 PATCH COMPLETE");
    console.log("=========================================");
}
