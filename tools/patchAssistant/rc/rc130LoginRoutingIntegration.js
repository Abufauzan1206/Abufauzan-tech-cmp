 ...
 *
 * RC130 - LOGIN ROUTING INTEGRATION
 *
 * Purpose:
 * 1. Verify canonical role routing.
 * 2. Verify legacy role routing.
 * 3. Verify unsupported roles are not routed to
 *    privileged dashboards.
 * 4. Verify auth.js contains the expected dashboard
 *    routing contract.
 *
 * =====================================================
 */
...
assert(
    authSource.includes('superAdmin') &&
    authSource.includes('super_admin'),
    "auth.js supports both Super Admin role aliases"
);

assert(
    authSource.includes('cooperativeAdmin') &&
    authSource.includes('cooperative_admin'),
    "auth.js supports both Cooperative Admin role aliases"
);
...
async function run() {
    ...
    console.log("=========================================");
    console.log("ABUFAUZAN TECH CMP");
    console.log("RC130 - LOGIN ROUTING INTEGRATION");
    console.log("=========================================");

    const result = await transaction(patches);

    console.log("RC130 TRANSACTION RESULT:");
    ...
    console.log("=========================================");
    console.log("RC130 PATCH COMPLETE");
    console.log("=========================================");
