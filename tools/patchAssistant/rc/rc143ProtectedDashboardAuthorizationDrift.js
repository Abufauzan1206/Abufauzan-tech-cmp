 ...
 *
 * RC143 - PROTECTED DASHBOARD AUTHORIZATION DRIFT
 *
 * Purpose:
 * Verify that protected dashboards cannot continue using
 * stale authorization when the Firestore role changes.
 *
 * Production files are modified through Patch Engine only.
 *
 * =====================================================
 */
...
async function run() {
    ...
    console.log("RC143 - PROTECTED DASHBOARD AUTHORIZATION DRIFT");
    console.log("=========================================");
