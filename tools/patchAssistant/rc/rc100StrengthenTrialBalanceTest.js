 ...
 *
 * RC100 - STRENGTHEN TRIAL BALANCE VERIFICATION
 * =====================================================
 */
...
const patches = [
    {
        path: "testTrialBalance.js",
        mode: "regex",
        search: `import \\{ CMPTransactionEngine \\} from "./js/business/transactionEngine\\.js";[\\s\\S]*$`,
        replace: `import { CMPTransactionEngine } from "./js/business/transactionEngine.js";
...
async function run() {
    console.log("=========================================");
    console.log("ABUFAUZAN TECH CMP");
    console.log("RC100 - STRENGTHEN TRIAL BALANCE TEST");
    console.log("=========================================");

    const result = await transaction(patches);

    console.log("RC100 TRANSACTION RESULT:");
    ...
    console.log("=========================================");
    console.log("RC100 PATCH COMPLETE");
    console.log("=========================================");
}
