...
const patches = [
    {
        ...
        search: `import { CMPMembershipApplicationEngine }
    from "../business/membershipApplicationEngine.js";`,
        replace: `import { CMPMembershipApplicationEngine }
    from "../business/membershipApplicationEngine.js";
...
if (!result.success) {
    process.exitCode = 1;
    throw new Error(
        "RC406-D67 PUBLIC MEMBERSHIP SUBMISSION SERVICE REPAIR: FAIL"
    );
}

console.log(
    "RC406-D67 PUBLIC MEMBERSHIP SUBMISSION SERVICE REPAIR: PASS"
);
